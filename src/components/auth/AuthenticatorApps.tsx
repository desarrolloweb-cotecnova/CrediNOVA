...
function PlayGlyph() {
  return (
    <svg viewBox="0 0 24 24" className="size-5" aria-hidden>
      <path d="M4.5 2.6 15.4 12 4.5 21.4c-.3-.2-.5-.6-.5-1V3.6c0-.4.2-.8.5-1z" fill="#00E676" />
      <path d="M15.4 12 4.5 2.6c.1-.05.2-.08.3-.1l10 5.7L15.4 12z" fill="#00C3FF" />
      <path d="M15.4 12 14.8 8.2l4.9 2.8c.5.3.5 1.1 0 1.4l-4.9 2.8L15.4 12z" fill="#FFC400" />
      <path d="M15.4 12 4.8 21.5c-.1-.02-.2-.05-.3-.1L14.8 15.8 15.4 12z" fill="#FF3D00" />
    </svg>
  );
}

/**
 * Botones para descargar Google Authenticator. `compact` acorta el texto.
 */
